...
public static class SalesManagement2023EfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE SalesManagement2023ModuleExtensionConfigurator CLASS (in the Domain.Shared project)
